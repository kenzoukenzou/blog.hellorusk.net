...
<Link href="https://matplotlib.org/3.1.0/api/_as_gen/matplotlib.pyplot.streamplot.html#matplotlib.pyplot.streamplot" color target="_blank">matplotlib.pyplot.streamplot — Matplotlib 3.1.0 documentation</Link>
