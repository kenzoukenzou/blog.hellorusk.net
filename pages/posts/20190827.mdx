...
すぐに[修正コミット](https://github.com/7ma7X/hellorusk.net/commit/d8a73174a39805c86a67738cda6dfadae0439740)を打ちました。 
  
<Microlink url={"https://github.com/7ma7X/hellorusk.net/commit/d8a73174a39805c86a67738cda6dfadae0439740"} style={microLinkStyle}/>
...
当ブログでは、パフォーマンスのため、ブログ一覧ページでは Next.js の `<Link>` ではなく、直接 `<a>` タグを使うようにしました。
