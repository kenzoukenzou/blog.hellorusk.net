...
<Iframely href="https://qiita.com/advent-calendar/2019/next-js" url="//cdn.iframe.ly/E2j92Z2?iframe=card-small" />
...
```md
import BlogLayout, { Iframely } from "../../components/blog-layout";
import BlogMeta from "../../components/blog-meta";
