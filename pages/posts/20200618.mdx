...
export const meta = {
  title: 'react-share にはてなブックマークを対応させた',
...
<Card>
  <h4><s>2020.7.10 追記</s></h4>
  <p><s>なかなかマージしてくれなさそうなので、記事のタイトルを「対応させたい」に変えました。</s>  
  <br/><s>この記事を読んで react-share にはてブが対応済だと思ってしまったらすみません。。。</s></p>
  <h4>2020.9.23 追記</h4>
  <p>マージされました！</p>
</Card>
