...
<Link href="https://github.com/szazo/DHT11_Python" color target="_blank">szazo/DHT11_Python: Pure Python library for reading DHT11 sensor on Raspberry Pi</Link>
